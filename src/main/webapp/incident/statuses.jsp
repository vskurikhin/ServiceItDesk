...
<%--
  ~ statuses.jsp
  ~ This file was last modified at 2019-02-09 23:46 by Victor N. Skurikhin.
  ~ $Id$
...
<head>
    ...
    <script language="javascript">
        var rootURL = '<c:out value="${baseURL}" /><%= Rest.API_URL + "/v1" + Rest.STATUS_RESOURCE %>'
    </script>
</head>
                    ...
                    <form id="statusForm">
                        <table class="tg2">
                            ...
                            <tr>
                                <td class="tg2-0lax">
                                    <label>Name:</label><br/>
                                    <input form="statusForm" type="text" id="status" name="status" class="my-text-name" required title=""/>
                                </td>
                            </tr>
                            <tr>
                                <td class="tg2-0lax">
                                    <label>Notes:</label><br/>
                                    <textarea form="statusForm" id="description" name="description" class="my-test-area" title=""></textarea>
                                </td>
                            </tr>
                        </table>
                    </form>
