...
<%--
  ~ incidents.jsp
  ~ This file was last modified at 2019-02-09 23:42 by Victor N. Skurikhin.
  ~ $Id$
                        ...
                        <table class="tg2">
                            <tr>
                                <td class="tg2-baqh" colspan="2">
                                    ...
                                    <button form="incidentForm" id="btnSearch" hidden>Search</button>
                                    <button form="incidentForm" id="btnComment" hidden>Резолюция</button>
                                    <button form="incidentForm" id="btnToWork" hidden>В работу</button>
                                    <button form="incidentForm" id="btnAnswer" hidden>Резолюция</button>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="tg2-0lax">
                                    <label>Name:</label><br/>
                                    <input form="incidentForm" type="text" id="title" name="title" class="my-text-name" required title=""/>
                                </td>
                            </tr>
                            <tr>
                                <td class="tg2-0lax">
