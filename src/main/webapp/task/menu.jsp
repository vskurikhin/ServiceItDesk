...
<%--
  ~ menu.jsp
  ~ This file was last modified at 2019-02-09 23:34 by Victor N. Skurikhin.
  ~ $Id$
            ...
            <td class="tg-0lax" colspan="2">
                <nav class="menu">
                    <ul>
                        ...
                        <li><a id="navigation-menu-1" href="<c:out value="${baseURL}/"/>incident/index.jsp">«Incedent Console»</a></li>
