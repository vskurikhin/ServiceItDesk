...
<%--
  ~ incidents.jsp
  ~ This file was last modified at 2019-02-11 23:08 by Victor N. Skurikhin.
  ~ $Id$
...
<head>
    <meta charset=UTF-8>
    <title id="head-title">Service It Desk «Консоль инцидентов» | JavaEE-09-2018 welcome</title>
...
<body class="body">
    ...
    <script type="text/javascript" language="javascript" src="<c:out value="${baseURL}/"/>js/coordinators/incidents.js"></script>
    </body>
</html>
