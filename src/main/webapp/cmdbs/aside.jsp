...
<%--
  ~ aside.jsp
  ~ This file was last modified at 2019-02-11 23:55 by Victor N. Skurikhin.
  ~ $Id$
...
<c:set var="baseURL" value="${req.scheme}://${req.serverName}:${req.serverPort}${req.contextPath}" />
                <aside class = "w3-col w3-margin-0 my-left-aside">
                    <ul>
                        <li><a id="aside-menu-0" href='<c:out value="${baseURL}/"/>cmdbs/groups.jsp'>«Группы»</a></li>
                        <li><a id="aside-menu-1" href='<c:out value="${baseURL}/"/>cmdbs/users.jsp'>«Пользователи»</a></li>
