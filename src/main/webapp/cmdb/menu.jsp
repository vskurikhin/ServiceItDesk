...
<%--
  ~ menu.jsp
  ~ This file was last modified at 2019-02-04 23:39 by Victor N. Skurikhin.
  ~ $Id$
            ...
            <td class="tg-0lax" colspan="2">
                <nav class="menu">
                    <ul>
                        ...
                        <li><a id="navigation-menu-1" href="<c:out value="${baseURL}/"/>cmdb/users.jsp">Пользователи</a></li>
