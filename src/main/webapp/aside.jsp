...
<%--
  ~ aside.jsp
  ~ This file was last modified at 2019-02-09 23:35 by Victor N. Skurikhin.
  ~ $Id$
...
<c:set var="baseURL" value="${req.scheme}://${req.serverName}:${req.serverPort}${req.contextPath}" />
                <aside class = "w3-col w3-margin-0 my-right my-main-aside">
                    <ul>
                        ...
                        <li><a id="aside-menu-1" href="<c:out value="${baseURL}/"/>incident/index.jsp">«Incedent Console»</a></li>
