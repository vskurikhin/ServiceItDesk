...
<%--
  ~ groups.jsp
  ~ This file was last modified at 2019-02-16 13:49 by Victor N. Skurikhin.
  ~ $Id$
...
<body class="body">
    ...
    <script type="text/javascript" language="javascript" src="<c:out value="${baseURL}/"/>js/cmdbs/groups.js"></script>
    </body>
</html>
